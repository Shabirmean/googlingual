  ...
  methods: {
    async addMessage(newMessage) {
      ...
      if (response.status !== 200 || !response.data) {
        alert(`Failed to translate message: ${newMessage.body}`);
        return;
      }
